 ...
 * Generated at: 2020-08-26 00:54:17 UTC
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      try {
        ...
        // /qna/qna_write.jsp(4,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_c_005fset_005f0.setVar("contextPath");
        // /qna/qna_write.jsp(4,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("    <title>문의작성</title>\r\n");
      out.write("    <link rel=\"stylesheet\" href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/css/qna_write.css\">\r\n");
      out.write("    <link rel=\"stylesheet\" href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      ...
      out.write("    <script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/js/qna_write.js\"></script>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      ...
      out.write("    <!--//sidebar_menu 영역-->\r\n");
      out.write("\r\n");
      out.write("    <!--write_wrapper 영역-->\r\n");
      out.write("    <div id=\"write_wrapper\">\r\n");
      out.write("        <h1>문의작성</h1>\r\n");
      out.write("        <!--write_form 영역-->\r\n");
      out.write("        <form class=\"write_form\" action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\\WebSendMail\" method=\"post\" enctype=\"multipart/form-data\">\r\n");
      out.write("        <!-- multipart/form-data는 form태그 안에서 post와 같은 방식으로 여러가지 데이터를 함께 묶어 전송하는 경우 사용 -->\r\n");
      out.write("            <h3>아래 작성한 이메일로 답변이 전달됩니다.</h3>\r\n");
      out.write("            <!--return_email 영역-->\r\n");
      out.write("            <div class=\"return_email\">\r\n");
      out.write("                <label for=\"email\">답변 수신<br>메일주소</label>\r\n");
      out.write("                <input type=\"email\" name=\"email\" id=\"email\">\r\n");
      out.write("            </div>\r\n");
      out.write("            <!--//return_email 영역-->\r\n");
      out.write("            <!--game_sele 영역-->\r\n");
      out.write("            <div class=\"game_sele\">\r\n");
      out.write("                <label for=\"game\">게임선택</label>\r\n");
      out.write("                <select name=\"game\" id=\"game\">\r\n");
      out.write("                    <option value=\"게임선택\">게임선택</option>\r\n");
      out.write("                    <option value=\"던전앤파이터\">던전앤파이터</option>\r\n");
      out.write("                    <option value=\"메이플스토리\">메이플스토리</option>\r\n");
      out.write("                    <option value=엘소드>엘소드</option>\r\n");
      out.write("                    <option value=\"클로저스\">클로저스</option>\r\n");
      out.write("                </select>\r\n");
      out.write("            </div>\r\n");
      out.write("            <!--//game_sele 영역-->\r\n");
      out.write("            <!--qna_kind 영역-->\r\n");
      out.write("            <div class=\"qna_kind\">\r\n");
      out.write("                <label for=\"kind\">문의분류</label>\r\n");
      out.write("                <select name=\"kind\" id=\"kind\">\r\n");
      out.write("                    <option value=\"문의분류\">문의분류</option>\r\n");
      out.write("                    <option value=\"버그\">버그</option>\r\n");
      out.write("                    <option value=\"거래\">거래</option>\r\n");
      out.write("                    <option value=\"가입 및 탈퇴\">가입 및 탈퇴</option>\r\n");
      out.write("                </select>\r\n");
      out.write("            </div>\r\n");
      out.write("            <!--//qna_kind 영역-->\r\n");
      out.write("            <!--qna_content 영역-->\r\n");
      out.write("            <div class=\"qna_content\">\r\n");
      out.write("                <div class=\"tit_wrap\">\r\n");
      out.write("                    <label for=\"tit\">제목</label>\r\n");
      out.write("                    <input type=\"text\" name=\"tit\" id=\"tit\"> \r\n");
      out.write("                </div>\r\n");
      out.write("                <textarea name=\"content\" id=\"content\" cols=\"30\" rows=\"10\" placeholder=\"내용을 입력해주세요.\"></textarea>\r\n");
      out.write("            </div>\r\n");
      out.write("            <!--//qna_content 영역-->\r\n");
      out.write("            <!--add_file 영역-->\r\n");
      out.write("            <div class=\"add_file\">\r\n");
      out.write("                <label for=\"file_tit\" class=\"file_tit\">첨부파일</label>\r\n");
      out.write("                <input class=\"upload-name\" value=\"파일선택\" disabled=\"disabled\">\r\n");
      out.write("                <input type=\"file\" id=\"ex_filename\" class=\"upload-hidden\" name=\"attachment\">\r\n");
      out.write("                <label for=\"ex_filename\" >파일선택</label>\r\n");
      out.write("                <label for=\"del_filename\" id=\"del_filename\">파일삭제</label>\r\n");
      out.write("            </div>\r\n");
      out.write("            <!--//add_file 영역-->\r\n");
      out.write("            <!--waring_msg 영역-->\r\n");
      out.write("            <ul class=\"warning_msg\">\r\n");
      out.write("                <li>개인정보 서류는 접수하지 않습니다.</li>\r\n");
      out.write("                <li>문의[제목]과 [내용]란에는 절대 개인정보를 입력하지 마세요.</li>\r\n");
      out.write("                <li>문의[제목]과 [내용]에 개인정보가 포함되어있거니, 중복 문의인 경우에는 삭제될 수 있습니다.</li>\r\n");
      out.write("            </ul>\r\n");
      out.write("            <!--//waring_msg 영역-->\r\n");
      out.write("            <!--btn_wrap 영역-->\r\n");
      out.write("            <div class=\"btn_wrap\">\r\n");
      out.write("                <input type=\"submit\" value=\"작성완료\" class=\"submit_btn\">\r\n");
      out.write("            </div>\r\n");
      out.write("            <!--//btn_wrap 영역-->\r\n");
      out.write("        </form>\r\n");
      out.write("        <!--//write_form 영역-->\r\n");
