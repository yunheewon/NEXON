...
<head>
    ...
    <title>아이디 찾기</title>
    <link rel="stylesheet" href="${contextPath}/css/id_find.css">
...
<body>
            ...
            <div class="form_container">
                <form action="" method="post" name="findfrm">
                    ...
                    <div class="id_form">
                        ...
                        <input type="text" name="name" id="name" class="form_control" placeholder="  이름을 입력하세요.">
                    </div>
                    <!--//id_form 영역-->
                    <!--email_form 영역-->
                    <div class="email_form">
                        <label for="email">이메일 주소</label>
                        <input type="email" class="form_control" name="email" id="email" placeholder="  이메일 주소를 입력하세요">
                    </div>
                    <!--//email_form 영역-->
                    <!--email_request 영역-->
                    <div class="email_request">
                        <p>인증번호를 요청하세요</p>
                        <button type ="button" class="request_btn" onclick="reqForId();">인증번호 요청</button>
                    ...
                    <div class="btn_container">
                        ...
                        <button type="submit" class="ok_btn" onclick="get_id();">아이디 찾기</button>
                    </div>
                    <!--btn_container 영역-->
                    <!--warning_msg 영역-->
                    <div class="warning_msg">
                        <p>- 본인 인증시 제공되는 정보는 인증 이외의 용도로 또는 저장하지 않습니다.</p>
                        <p>- 인증번호가 발송되지않을 경우 '넥슨'연락처가 스팸으로 분류되어 있는지 확인바랍니다.</p>
                    </div>
                    <!--//warning_msg 영역-->
                </form>
            </div>
    ...
    <!--//footer 영역-->
    <script src="${contextPath}/js/id_find.js"></script>
</body>
</html>