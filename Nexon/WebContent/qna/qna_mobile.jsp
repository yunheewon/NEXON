...
<head>
    ...
    <title>문의하기 - 모바일</title>
    <link rel="stylesheet" href="${contextPath}/css/qna_mobile.css">
            ...
            <ul class="game_list">
                ...
                <li class="list_item">
                    <a href="${contextPath}/qna/qna_write.jsp">
                        <img src="http://help.nexon.com/image/gameicon/fac8103f8a4147e580374125742345ce.png" alt="메이플스토리M 고객센터 바로가기">
                        <span>메이플스토리M</span>
                    </a>
                </li>
                <li class="list_item">
                    <a href="${contextPath}/qna/qna_write.jsp">
                        <img src="http://help.nexon.com/image/gameicon/c7fd80c3bcf4494bba47d830239cdf6e.png" alt="삼국지조조선 고객센터 바로가기">
                        <span>삼국지조조선</span>
                    </a>
                </li>
                <li class="list_item">
                    <a href="${contextPath}/qna/qna_write.jsp">
                        <img src="http://help.nexon.com/image/gameicon/72e442a9f0ef4f09a6f342e4ce6eaa1a.png" alt="V4 고객센터 바로가기">
                        <span>V4</span>
                    </a>
                </li>
                <li class="list_item">
                    <a href="${contextPath}/qna/qna_write.jsp">
                        <img src="http://help.nexon.com/image/gameicon/0fca003977fd4e1b938394f4972e5fcd.jpg" alt="다크어벤저3 고객센터 바로가기">
                        <span>다크어벤저3</span>
                    </a>
                </li>
                <li class="list_item">
                    <a href="${contextPath}/qna/qna_write.jsp">
                        <img src="http://help.nexon.com/image/gameicon/0e90efcf73f24a538cb085b7cd369f84.png" alt="스페셜솔져 고객센터 바로가기">
                        <span>스페셜솔져</span>
                    </a>
                </li>
                <li class="list_item">
                    <a href="${contextPath}/qna/qna_write.jsp">
                        <img src="http://help.nexon.com/image/gameicon/0ee67bddd0174893a27c1d843a656d6b.png" alt="AXE" 고객센터 바로가기">
                        <span>AXE</span>
                    </a>
                </li>
                <li class="list_item">
                    <a href="${contextPath}/qna/qna_write.jsp">
                        <img src="http://help.nexon.com/image/gameicon/a25cedd7021d476da910d46a37b9d009.png" alt="OVERHIT 고객센터 바로가기">
                        <span>OVERHIT</span>
                    </a>
                </li>
                <li class="list_item">
                    <a href="${contextPath}/qna/qna_write.jsp">
                        <img src="http://help.nexon.com/image/gameicon/45230e08e52642d8abb6ad4966549aea.png" alt="런웨이스토리 고객센터 바로가기">
                        <span>런웨이스토리</span>
                    </a>
                </li>
                <li class="list_item">
                    <a href="${contextPath}/qna/qna_write.jsp">
                        <img src="http://help.nexon.com/image/gameicon/4478614707cd4e3792d93ae1bb6b5738.png" alt="트라하 고객센터 바로가기">
                        <span>트라하</span>
                    </a>
                </li>
                <li class="list_item">
                    <a href="${contextPath}/qna/qna_write.jsp">
                        <img src="http://help.nexon.com/image/gameicon/b83a8ac2710e471e97e2b25114728553.png" alt="카운터사이드 고객센터 바로가기">
                        <span>마비노기</span>
                    </a>
                </li>
                <!--//list_item 영역-->
